...
const DashboardCard = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
      <div className="p-4 rounded-sm shadow-sm flex items-center gap-4 transition-transform hover:scale-[1.05] bg-muted">
...
const RecentOrders = () => {
  ...
  if (data === null) return;
  return (
    <section className=" rounded-md shadow-sm bg-muted relative">
