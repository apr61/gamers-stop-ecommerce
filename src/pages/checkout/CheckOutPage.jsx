...
function CheckOutPage() {
  ...
  const conditionForDisabledPlaceOrder =
    checkoutAddress == undefined ||
    checkoutPaymethod == undefined ||
    cart.length === 0;
  const deliveryDateFormatted = dateFormatter(deliveryDateSetter(deliveryDays))
    .split(",")
    .join(" ");
    ...
    <>
      ...
      <section className="checkout__body main">
        <Accordion
          ...
          modifiedStyles={"checkout__acc-title"}
          defaultOpen={true}
        >
          <div className="checkout__section">
            {loading ? (
              ...
              <>
                ...
                >
                  Create a new shiping address here
                </Link>
              </>
            ) : (
                ...
                {checkoutAddress ? (
                  <>
                    <div className="checkout__address-card">
                      <h4 className="checkout__address-card checkout__address-card--heading">
                        {checkoutAddress.fullName}
                      </h4>
                      <p className="checkout__address-card">
                        {checkoutAddress.flat}
                      </p>
                      <p className="checkout__address-card">
                      ...
                      <p className="checkout__address-card">
                        {checkoutAddress.town},{" "}
                        {checkoutAddress.state.toUpperCase()}{" "}
                    ...
                    <button
                      className="checkout__btn checkout__btn--action"
                      ...
                      {addresses.map((address) => (
                        <div className="input-radio" key={address.id}>
                          ...
                          >
                            ...
                            India, Phone Number: {address.phoneNumber}
                          </label>
                        </div>
                      ))}
                    </div>
        ...
        <Accordion
          title={"2 - Schedule Your Delivery"}
          modifiedStyles={"checkout__acc-title"}
          defaultOpen={true}
        >
          <div className="checkout__section">
        ...
        <Accordion
          title={"4 - Review Items And Delivery"}
          modifiedStyles={"checkout__acc-title"}
          defaultOpen={true}
        >
          <div className="checkout__section">
        ...
        <div className="checkout__order-summary">
          <button
            className={
              conditionForDisabledPlaceOrder
                ? "checkout__btn checkout__btn--disabled"
                : "checkout__btn"
            }
            disabled={conditionForDisabledPlaceOrder}
            title={conditionForDisabledPlaceOrder && "Please fill all details"}
          ...
          <div className="checkout__order-details">
            ...
            <table className="checkout__table">
              <tbody className="checkout__tbody">
                <tr className="checkout__tr">
                  ...
                  <td className="checkout__td checkout__td--end">
                    {totalItems}
                  </td>
                </tr>
                <tr className="checkout__tr">
            ...
            <p className="checkout__order-total">
              Order Total: {currencyFormatter(totalPrice + deliveryFee)}
            </p>
          </div>
        </div>
      </section>
